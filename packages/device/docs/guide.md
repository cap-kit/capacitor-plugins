...
This guide covers the App Store privacy manifest requirements you must satisfy when using the plugin in an iOS app, including the required reason API declaration and an example `PrivacyInfo.xcprivacy` file.
