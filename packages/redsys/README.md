...
- [Usage guide](docs/guide.md) — Direct Payment and 3-D Secure WebView flows, HMAC signature generation, error handling, and response structure
- [Configuration guide](docs/configuration.md) — native SDK distribution & setup, platform-specific configuration, and UI customization
...
- 🤖 [In-App Integration for Android devices](https://pagosonline.redsys.es/desarrolladores-inicio/documentacion-operativa/integracion-inapp-para-dispositivos-android/)
- 🍎 [In-App Integration for iOS devices](https://pagosonline.redsys.es/desarrolladores-inicio/documentacion-operativa/integracion-inapp-para-dispositivos-ios/)
