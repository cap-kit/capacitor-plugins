package io.capkit.sslpinning.model

/**
 * Canonical, nominal result model for SSL pinning operations on Android.
 * This data class is exchanged between the native implementation (SSLPinningImpl)
 * and the bridge (SSLPinningPlugin) and serialized to JavaScript via a JSObject.
 *
...
data class SSLPinningResultModel(
  ...
  /** Active mode: "fingerprint" | "cert" | "excluded". */
